var productList = [
  ...
  var img = document.querySelector(".card img:nth-child(1)");
  img.src = productList[0].preview;
  var desc = document.querySelector(".card-body h6:nth-child(1)");
  desc.innerHTML = productList[0].name;
  var brand = document.querySelector(".card-body p:nth-child(2)");
  brand.innerHTML = productList[0].brand;
  var price = document.querySelector(".card-body p:nth-child(3)");
  price.innerHTML = "Rs" + " " + productList[0].price;

  var img1 = document.querySelector(".card:nth-child(2) img:nth-child(1)");
  img1.src = productList[1].preview;
  var desc1 = document.querySelector(".card:nth-child(2) .card-body h6:nth-child(1)");
  desc1.innerHTML = productList[1].name;
  var brand1 = document.querySelector(".card:nth-child(2) .card-body p:nth-child(2)");
  brand1.innerHTML = productList[1].brand;
  var price1 = document.querySelector(".card:nth-child(2) .card-body p:nth-child(3)");
  price1.innerHTML = "Rs" + " " + productList[1].price;

  var img2 = document.querySelector(".card:nth-child(3) img:nth-child(1)");
  img2.src = productList[2].preview;
  var desc2 = document.querySelector(".card:nth-child(3) .card-body h6:nth-child(1)");
  desc2.innerHTML = productList[2].name;
  var brand2 = document.querySelector(".card:nth-child(3) .card-body p:nth-child(2)");
  brand2.innerHTML = productList[2].brand;
  var price2 = document.querySelector(".card:nth-child(3) .card-body p:nth-child(3)");
  price2.innerHTML = "Rs" + " " + productList[2].price;

  var img3 = document.querySelector(".card:nth-child(4) img:nth-child(1)");
  img3.src = productList[3].preview;
  var desc3 = document.querySelector(".card:nth-child(4) .card-body h6:nth-child(1)");
  desc3.innerHTML = productList[3].name;
  var brand3 = document.querySelector(".card:nth-child(4) .card-body p:nth-child(2)");
  brand3.innerHTML = productList[3].brand;
  var price3 = document.querySelector(".card:nth-child(4) .card-body p:nth-child(3)");
  price3.innerHTML = "Rs" + " " + productList[3].price;

  var img4 = document.querySelector(".card:nth-child(5) img:nth-child(1)");
  img4.src = productList[4].preview;
  var desc4 = document.querySelector(".card:nth-child(5) .card-body h6:nth-child(1)");
  desc4.innerHTML = productList[4].name;
  var brand4 = document.querySelector(".card:nth-child(5) .card-body p:nth-child(2)");
  brand4.innerHTML = productList[4].brand;
  var price4 = document.querySelector(".card:nth-child(5) .card-body p:nth-child(3)");
  price4.innerHTML = "Rs" + " " + productList[4].price;

  var img5 = document.querySelector(".box2 .card img:nth-child(1)");
  img5.src = productList[5].preview;
  var desc5 = document.querySelector(".box2 .card-body h6:nth-child(1)");
  desc5.innerHTML = productList[5].name;
  var brand5 = document.querySelector(".box2 .card-body p:nth-child(2)");
  brand5.innerHTML = productList[5].brand;
  var price5 = document.querySelector(".box2 .card-body p:nth-child(3)");
  price5.innerHTML = "Rs" + " " + productList[5].price;

  var img6 = document.querySelector(".box2 .card:nth-child(2) img:nth-child(1)");
  img6.src = productList[6].preview;
  var desc6 = document.querySelector(".box2 .card:nth-child(2) .card-body h6:nth-child(1)");
  desc6.innerHTML = productList[6].name;
  var brand6 = document.querySelector(".box2 .card:nth-child(2) .card-body p:nth-child(2)");
  brand6.innerHTML = productList[6].brand;
  var price6 = document.querySelector(".box2 .card:nth-child(2) .card-body p:nth-child(3)");
  price6.innerHTML = "Rs" + " " + productList[6].price;

  var img7 = document.querySelector(".box2 .card:nth-child(3) img:nth-child(1)");
  img7.src = productList[7].preview;
  var desc7 = document.querySelector(".box2 .card:nth-child(3) .card-body h6:nth-child(1)");
  desc7.innerHTML = productList[7].name;
  var brand7 = document.querySelector(".box2 .card:nth-child(3) .card-body p:nth-child(2)");
  brand7.innerHTML = productList[7].brand;
  var price7 = document.querySelector(".box2 .card:nth-child(3) .card-body p:nth-child(3)");
  price7.innerHTML = "Rs" + " " + productList[7].price;

  var img8 = document.querySelector(".box2 .card:nth-child(4) img:nth-child(1)");
  img8.src = productList[8].preview;
  var desc8 = document.querySelector(".box2 .card:nth-child(4) .card-body h6:nth-child(1)");
  desc8.innerHTML = productList[8].name;
  var brand8 = document.querySelector(".box2 .card:nth-child(4) .card-body p:nth-child(2)");
  brand8.innerHTML = productList[8].brand;
  var price8 = document.querySelector(".box2 .card:nth-child(4) .card-body p:nth-child(3)");
  price8.innerHTML = "Rs" + " " + productList[8].price;

  var img9 = document.querySelector(".box2 .card:nth-child(5) img:nth-child(1)");
  img9.src = productList[9].preview;
  var desc9 = document.querySelector(".box2 .card:nth-child(5) .card-body h6:nth-child(1)");
  desc9.innerHTML = productList[9].name;
  var brand9 = document.querySelector(".box2 .card:nth-child(5) .card-body p:nth-child(2)");
  brand9.innerHTML = productList[9].brand;
  var price9 = document.querySelector(".box2 .card:nth-child(5) .card-body p:nth-child(3)");
  price9.innerHTML = "Rs" + " " + productList[9].price;



// var desc = document.getElementById("card-title")
...
//     desc.innerHTML = productList[i].name;
